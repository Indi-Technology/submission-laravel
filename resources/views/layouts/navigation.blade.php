<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- Dropdown for Articles, Categories, Tags -->
                            ...
                            <x-dropdown align="right" width="48">
                                <x-slot name="trigger">
                                    <button
                                        ...
                                        {{ __('Resources') }}
                                        <svg class="-mr-1 ml-2 h-5 w-5" fill="none" stroke="currentColor"
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        <!-- Dropdown for Articles, Categories, Tags -->
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('article.index')">
                {{ __('Articles') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('category.index')">
                {{ __('Categories') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('tag.index')">
                {{ __('Tags') }}
            </x-responsive-nav-link>
        </div>
