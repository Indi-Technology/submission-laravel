<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <x-link :href="route('categories.create')">Create
                Category</x-link>
                                    ...
                                    <table class="min-w-full text-left text-sm font-light">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="border-b dark:border-neutral-500">
                                                <td class="whitespace-nowrap px-6 py-4 font-medium">{{$category->id}}
                                                </td>
                                                <td class="whitespace-nowrap px-6 py-4">{{$category->name}}</td>
                                                <td class="whitespace-nowrap px-6 py-4">
                                                    <x-link :href="route('categories.edit', $category->id)">Edit
                                                    </x-link>
