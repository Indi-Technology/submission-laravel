    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <div class="max-w-2xl lg:mx-0">
                <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl mb-3">Manage Category</h2>
                <span class="flex justify-between items-center">
                    ...
                    <a href="{{ route('admin.categories.add') }}"
                        class="bg-blue font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center">
                        Add Category
