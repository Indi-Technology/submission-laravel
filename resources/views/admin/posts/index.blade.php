...
<x-app-layout>
    ...
    <h2 class="font-semibold text-xl text-gray-800 leading-tight">
        <div class="max-w-2xl lg:mx-0">
            <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl mb-3">Manage Story</h2>
            <span class="flex justify-between items-center">
                ...
                <a href="{{ route('admin.posts.add') }}" class="bg-blue font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center">
                    Add Story
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 text-gray-600 text-sm">
                            @foreach ($posts as $index => $post)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">{{ $post->created_at->format('d M Y') }}
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <a href="{{ route('admin.posts.edit', $post->id) }}" class="text-blue-600 hover:text-blue-900 mr-2">
